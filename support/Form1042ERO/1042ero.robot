...
ProcessReturn-Form1042ERO       
    ...
    ${1042}=    	set Variable    //span[contains(text(),"Form 1042")] 
    Open Workbook      ${wbook}
    ...
    FOR    ${i}    IN RANGE   2   5
      ...
      sleep  15s
      ${passed} =    Run Keyword And Return Status         Wait Until Element Is Enabled       //*[@id="app"]/div/div/div/main/div[2]/div[2]/div[3]/div[2]/div[2]/a/span[3]    100s
      Run Keyword If	${passed}    Click Element    //*[@id="app"]/div/div/div/main/div[2]/div[2]/div[3]/div[2]/div[2]/a/span[3]
      sleep	10s
      ${obj_ID}=    Get cell value    ${i}    A   Form1042   
      ${obj_Des}=    Get cell value    ${i}    B   Form1042
      ${obj_Expected}=		Get cell value    ${i}    BV   Form1042
      ${obj_PActual}=		Get cell value    ${i}    BW   Form1042
      ${obj_NActual}=		Get cell value    ${i}    BU   Form1042

      ${WithholdingAgentName}=    Get cell value    ${i}    C   Form1042
