...
*** Settings ***
Resource   ../../support/1042cpa_support.robot
...
Login to Account
  ...
  ${uid}=    	set Variable    puvanasri.j+1042cpaUAT@spantechnologyservices.com  
  ...
  Remove Files   ../../Test suite/Form1042CPA/Screenshot/*.png
